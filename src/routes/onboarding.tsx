...
function Onboarding() {
  ...
  return (
    <PhoneFrame>
      ...
      <div key={i} className="mt-12 px-7 animate-fade-up">
      ...
      {/* Footer CTA */}
      <div className="fixed inset-x-0 bottom-0 mx-auto w-full max-w-[440px] px-6 pb-6 pt-12 bg-gradient-to-t from-background via-background/85 to-transparent">
        <button
          onClick={next}
        ...
        <div className="mt-3 text-center text-[10px] uppercase tracking-[0.3em] text-muted-foreground/60">
